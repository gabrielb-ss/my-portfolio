...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <section className="relative flex  items-center justify-center px-6 py-14 lg:px-20">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="grid w-full bg-slate-50 px-8 py-10 rounded-2xl max-w-7xl grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center"
        >
          {/* Lado Esquerdo: Texto */}
          <div className="flex flex-col space-y-6">
            <motion.span 
              variants={itemVariants}
              className="text-sm font-medium tracking-wide px-4 py-2 rounded-2xl bg-slate-200/50 w-fit text-blue-600 uppercase"
            >
            ...
            <motion.h1 
              variants={itemVariants}
              className="text-5xl font-bold leading-none text-slate-900 md:text-7xl"
            >
